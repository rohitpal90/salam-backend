...
public class SwaggerDocConfig {
    ...
    public OpenAPI baseOpenAPI() throws IOException {
        var responseJson = loadResource(exampleResource);
    ...
    private JsonNode loadResource(Resource resource) throws IOException {
        return OBJECT_MAPPER.readValue(resource.getInputStream(), JsonNode.class);
    }
